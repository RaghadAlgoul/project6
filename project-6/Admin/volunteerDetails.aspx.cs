...
namespace project6.Admin
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //if (!IsPostBack)
            //{
            //    try { email.InnerHtml += DetailsView1.Rows[2].Cells[1].Text; }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand comm = new SqlCommand($"update Volunteer set State_volunteer=@state WHERE  [Id_volunteer] = @Id_volunteer", con);

                con.Open();
                comm.Parameters.AddWithValue("@Id_volunteer", DetailsView1.Rows[0].Cells[1].Text);
